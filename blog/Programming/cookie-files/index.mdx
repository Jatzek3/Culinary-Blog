...
subtitle: "Where the browser stores information"
date: "2021-08-31"
...
hero_image_alt: "Plate of chocolate chip cookies"
hero_image_credit_text: "Cyr0z"
hero_image_credit_link: "https://www.flickr.com/people/12162820@N03"
---
...
Cookies are small messages(4kb), which the website sends to you your browser 
and then it is saved until it expires (or the browser window is closed
...
has 5MB of capacity. It is very easy to enter from the developer's 
point of view and allows for getting by without accessing the backend. Since it is
