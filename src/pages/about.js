        ...
        <Layout pageTitle="About Me">
            <div className={text}>
                ...
                <p className={textParagraph}> During this time, I've made many applications.
                    Some of them are available on my
                    <a href="https://github.com/Jatzek3" className={textParagraphLink} target="blank">Github</a>
                    and selected few are on
                    <Link className={textParagraphLink} to="/apps">Apps</Link>.</p>
